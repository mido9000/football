...
export default class Home extends Component {
  ...
  render() {
    ...
    <Image  style={{ width:screenWidth,height:screenWidth*500/1000,marginTop:10,marginBottom:10}} source={require('../Img/6.jpg')}></Image>
    <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
    <Image  style={{height:100,width:100}} source={require('../Img/5.png')}></Image>
    </View>
    <View style={{flex:2 }}>
